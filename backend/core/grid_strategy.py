...
class GridStrategy:
    ...
    def __init__(self, trading_pair: str, upper_price: Decimal, lower_price: Decimal, grid_count: int, total_investment: Decimal) -> None:
    ...
    def calculate(self) -> GridCalculationResult:
        ...
        return GridCalculationResult(
            grid_spacing=grid_spacing.quantize(Decimal("0.00000001")),
